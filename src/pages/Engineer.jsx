...
export default function Engineer() {
  ...
  // Calculate dynamic stats: Total engineers per Panchayat
  const panchayatStats = useMemo(() => {
    const stats = {};
    engineers.forEach(eng => {
      stats[eng.panchayat] = (stats[eng.panchayat] || 0) + 1;
    });
    return Object.entries(stats).sort((a, b) => b[1] - a[1]); // Sort by highest count
  }, [engineers]);
  ...
  return (
    <div className="space-y-6 pb-10">
      ...
      <div className="bg-white p-5 border border-gray-200 rounded-xl shadow-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-xl font-bold text-gray-900">Engineer Master</h2>
          <p className="text-sm text-gray-500">Manage technical personnel and assignments.</p>
        </div>
        <button 
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200 text-sm text-left">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-6 py-3 font-semibold text-gray-700">Engineer Name</th>
                ...
                <th className="px-6 py-3 font-semibold text-gray-700">Assigned Panchayat</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200">
              {engineers.length === 0 ? (
                <tr><td colSpan="4" className="px-6 py-8 text-center text-gray-500">No engineers added yet.</td></tr>
              ) : (
                engineers.map((eng) => (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/50 backdrop-blur-sm p-4">
          <div className="bg-white rounded-xl shadow-xl border border-gray-200 w-full max-w-lg">
            <div className="flex justify-between items-center p-5 border-b border-gray-200 bg-gray-50 rounded-t-xl">
              <h3 className="text-lg font-bold text-gray-900">Register New Engineer</h3>
            ...
            <form onSubmit={handleSubmit} className="p-5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  <label className="text-sm font-medium text-gray-700">Assign Panchayat</label>
